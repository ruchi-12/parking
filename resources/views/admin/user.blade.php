              ...
              <div id="search-form">
                 <div class="container h-100">
                    <div class="d-flex justify-content-center h-100">
                        <div class="searchbar">
                            <input class="search_input" type="text" id="userSearch" name="search" placeholder="Search..." autocomplete="off">
                    ...
                    <br>
                  <select class="form-control form-group select" name="Sort" id="SortUser">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody >
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="delete/user/{{$value->id}}"><i class="far fa-trash-alt"></i></a>
                          </td>
                        </tr>
                        @endforeach
